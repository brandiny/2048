...
class MainMenu(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        menu_button2 = tk.Button(button_frame, text='Load Game', command=lambda: controller.show_frame(MainGame, new_game=False))
...
class MainGame(tk.Frame):
    ...
    def __init__(self, parent, controller, new_game=True):
        ...
        # add the back button
        self.back_button_game = tk.Button(self, text='Save and go back', font=controller.DESCRIPTION_FONT, command=self.save_game)
